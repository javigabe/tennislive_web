        ...
        <div className="register-app">
            <div className="choose" style={
                ...
                <button className="email-register-button" onClick={() => registerEmail()}>
                    <img className="email-img" src='https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/mail.svg'/>
                    <span classname="email-register-text"> Register with email </span>
                </button> 
                <StyledFirebaseAuth className="registerUI" uiConfig={uiConfig} firebaseAuth={firebase.auth()} />
            </div>
            
            <div className="emailRegister" style={
                {display: showEmail}
            }>
                <input
                    type="email"
                ...
                />
                <br/>
                <button onClick={() => createUser(email, password, confirmPassword)}>
                    Register
                </button>
            </div>
        </div>
