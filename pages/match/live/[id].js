        ...
        return (
            <Tabs id="resumen-tabs" className="mt-2 mb-2">
                    <Tab eventKey="scoreboard" title="Scoreboard">
                        <Container>
                            <Container className="match-sc-text">
                                Scoreboard
                            </Container>
    ...
    const fillStatsTable = (stats) => {
        ...
        return (
            <Table className="stats-table" borderless responsive size="sm">
                ...
                <tbody>
                    <Container className="stats-info-text">
                        Aces
                    </Container>
                    <tr>
                        <td>{stats['aces'][0]}</td>
            ...
            <Container className="match">
                <Container className="match-resume">
                    <Container className="match-imgs mt-5">
                        <img alt="wh-icon" className="player1-match-img" src="https://images.theabcdn.com/i/24738724/300x300/c"/>
                        <img alt="wh-icon" className="player2-match-img" src="https://images.theabcdn.com/i/24738724/300x300/c"/>
                    </Container>
                    <Container className="players-info mt-2">
                        <div className="player1-info mt-2">
                            {player1}
                        </div>
                        <div className="scoreboard mt-2">
                            {props.info.match.scoreboard.sets.sets1}
                            -
                            {props.info.match.scoreboard.sets.sets2}
                        </div>
                        <div className="player2-info mt-2">
                            {player2}
                        </div>
                    </Container>
                </Container>
                <Container>
                    <Tabs id="nav" className="mt-4 mb-3 nav-pills">
                        ...
                        <Tab eventKey="Mtos" title="Mtos">
                            {fillMtos(player1, player2, props.info[props.info.match.player1.name], props.info[props.info.match.player2.name])}
                        </Tab>
